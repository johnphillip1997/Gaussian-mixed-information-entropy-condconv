...
def get_model(model):
    ...
    if model=='R32_C10':
        layer_config = [2, 2, 2, 0]
        rnet = resnet.FlatResNet32(base.BasicBlock, layer_config, num_classes=2)
        agent = resnet.Policy32([1,1,1], num_blocks=6)
